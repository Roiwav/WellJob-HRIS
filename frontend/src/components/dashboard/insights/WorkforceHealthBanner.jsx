...
export default function WorkforceHealthBanner({
  ...
  const HealthIcon = tone.iconComponent;
  const healthScore = getSafeScore(
    health.score
  );
          ...
          <div className="min-w-0">
            <div className="flex flex-wrap items-center gap-2">
              <h2
                ...
                className={`text-base font-extrabold ${tone.text}`}
              >
                {health.title ||
                  "Workforce Health"}
              </h2>
            ...
            <p
              className={`mt-1 text-sm leading-6 ${tone.muted}`}
            >
              {health.summary ||
                "Current workforce indicators are available for management review."}
            </p>
