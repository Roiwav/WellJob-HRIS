...
export default function Employees() {
   ...
   *
   * HR_COORDINATOR:
   * - view assigned-company employees
   * - view employee documents
   * - no add
   * - no edit
   * - no archive
   *
   * Backend remains authoritative for company scope.
   */
            ...
            await axios.get(
              EMPLOYEE_API_URL,
              {
                ...
                params: {
                   ...
                   *
                   * employeeController forces active
                   * company-scoped records for the
                   * coordinator role.
                   */
                  scope:
                    "active",
  ...
  const handleSaveSuccess =
    useCallback(
      async (
        ...
        /*
         * Add/Edit modals cannot be mounted for
         * read-only roles. Keep this guard as
         * defense in depth.
         */
        if (
          isReadOnlyEmployeeAccess
